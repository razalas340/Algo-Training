...
// const arrNested = [1, [3, [10], 6]];
// console.log(nestedArrMax(arrNested)); // 10
...
const nestedArrMaxLevel = (arr, level) => {
  ...
  function search(arr, curLevel, level) {
    for (let i = 0; i < arr.length; i++) {
      let element = arr[i];
...
const arrNested3 = [1, [3, [10], 6]];
// console.log(nestedArrMaxLevel(arrNested3, 1)); // 1

console.log(nestedArrMaxLevel(arrNested3, 1));

// console.log(nestedArrMaxLevel(arrNested3, 3)); // 10
